 ...
 speed of sound $c_s$ 
  ...
  \begin{figure}
    ...
    \caption{
      ...
      $f / M_{\rm P} < 1$ consistent with all the experimental data.}
    \label{fig4}
  \end{figure}
  ...
  Finally in Fig.(\ref{fig4}) we exhibit that the analysis contains a significant part of the parameter space where
