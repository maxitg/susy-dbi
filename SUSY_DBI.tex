...
\title{Supersymmetric Dirac-Born-Infeld Axionic Inflation and Non-Gaussianity}
...
\section{Model simulation and experimental test \label{sec6}}
  ...
  \begin{figure}
    ...
    \caption{
      ...
      The blue region enclosed by the blue line is the one allowed by experiment in the 2$\sigma$ range.      
      ...
      are consistent with Planck constraints as shown by green points while the red points lie outside the 68\% CL contour.
            Right panel: A plot of non-Gaussianity parameter $f_{NL}$ as
      ...
      and the red dots are parameter points which are outside the experimentally allowed region  on $r$ and $n_s$. The horizontal black line is the
