...
that our references to the analysis of non-Gaussianity from the Planck experiment need updating. We have
...
Figs (1) and (2) with new ones using $\ddot {a}=0$ constraint and a comparison of the new and old figs shows that
they are remarkably similar. Further, we have replaced Eq.(6.1) with the new constraint.
}
